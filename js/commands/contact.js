    ...
    execute: () => {
        return `<div class="command-output">
            ...
            <div class="mb-2">
                ...
                <a href="mailto:chaitknight@proton.me" class="link">chait@example.com</a>
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <a href="https://github.com/chaithaha" target="_blank" class="link">github.com/chait</a>
            </div>
            <div class="mb-2">
                <i data-feather="linkedin" class="inline mr-2"></i>
                <a href="https://linkedin.com/in/chaitG" target="_blank" class="link">linkedin.com/in/chait</a>
            </div>
        </div>`;
    }
};
